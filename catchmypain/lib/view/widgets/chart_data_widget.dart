...
import 'package:catchmypain/controller/filled_below_curvedLine_draw_angle.dart';
    ...
    return Stack(
      children: [
        ...
        CustomPaint(
          ...
          painter: exerciseCount!
              ? FilledBelowCurvedPainter(usedData, yLength, reversedList,
                  iconSize, dataNum!, filledCheck, lineCheck)
              : FilledBelowCurvedPainterAngle(usedData, yLength, reversedList,
                  iconSize, dataNum!, filledCheck, lineCheck),
        ),
